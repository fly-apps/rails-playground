...
class SandwichesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sandwich" do
    assert_difference("Sandwich.count") do
      post sandwiches_url, params: { sandwich: { category: @sandwich.category, name: @sandwich.name } }
    end
  ...
  test "should update sandwich" do
    patch sandwich_url(@sandwich), params: { sandwich: { category: @sandwich.category, name: @sandwich.name } }
